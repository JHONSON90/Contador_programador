        ...
        rx.vstack(
            ...
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.card(
                        rx.vstack(
                        rx.image(alt="Solicitando autorizacion para colocar imagenes del proyecto",height = "180px", width = "100%"),
                    ...
                    rx.card(
                        rx.vstack(
                        rx.image(src="/programador/todo.JPG", alt="imagen del proyecto al colocar una nueva tarea", 
